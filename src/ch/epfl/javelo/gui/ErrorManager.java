...
public final class ErrorManager {
    ...
    private final static int FADE_START_DURATION = 200;
    private final static int FADE_END_DURATION = 500;
    private final static int PAUSE_DURATION = 2000;
    private final static double MIN_FADE_VALUE = 0;
    private final static double MAX_FADE_VALUE = 0.8;
    ...
    public void displayError(String errorMessage) {
        ...
        //java.awt.Toolkit.getDefaultToolkit().beep(); // sound indicating the error (disabled)
