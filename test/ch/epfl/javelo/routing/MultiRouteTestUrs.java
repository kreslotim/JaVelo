...
class MultiRouteTestUs {
    ...
    void create() {
        ...
        List<Route> routes3 = List.of(multiRoute2, multiRoute3);
    ...
    void IndexOfSegmentAtWorksOnMixedRoutes() {
        ...
        assertEquals(0, multiRoute4.indexOfSegmentAt(650));
        assertEquals(0, multiRoute4.indexOfSegmentAt(700));
    ...
    void LengthWorks() {
        ...
        double expectedLength1And4 = singleRoute1.length() + singleRoute2.length() + singleRoute3.length() + singleRoute4.length();
        ...
        assertEquals(expectedLength1And4, multiRoute1.length());
        assertEquals(expectedLength2, multiRoute2.length());
        assertEquals(expectedLength3, multiRoute3.length());
        assertEquals(expectedLength1And4, multiRoute4.length());
    }
    ...
    void EdgesWorks() {
        ...
        List<Edge> expected1And4 = new ArrayList<>();
        expected1And4.addAll(edges1);
        expected1And4.addAll(edges2);
        expected1And4.addAll(edges3);
        expected1And4.addAll(edges4);
        ...
        assertEquals(expected1And4, multiRoute1.edges());
        assertEquals(expected2, multiRoute2.edges());
        assertEquals(expected3, multiRoute3.edges());
        assertEquals(expected1And4, multiRoute4.edges());
    }
    ...
    void PointsWorks() {
        ...
        List<PointCh> expectedPoints1And4 = List.of(point1, point2, point3, point4, point3, point4, point5, point6, point5, point6, point7, point8, point7, point8);
        ...
        assertEquals(expectedPoints1And4, multiRoute1.points());
        assertEquals(expectedPoints2, multiRoute2.points());
        assertEquals(expectedPoints3, multiRoute3.points());
        assertEquals(expectedPoints1And4, multiRoute4.points());
    }
    ...
    void ElevationAtWorksOnKnownValues() {
        ...
        assertEquals(39.11099408612291, multiRoute1.elevationAt(100));
        assertEquals(10.96713441948415, multiRoute1.elevationAt(500));
        assertEquals(77.72979530758599, multiRoute1.elevationAt(600));
        assertEquals(68.7166028911134, multiRoute1.elevationAt(1000));
        assertEquals(60.37202453747647, multiRoute1.elevationAt(2100));

        assertEquals(39.11099408612291, multiRoute2.elevationAt(100));
        assertEquals(76.44397634449163, multiRoute2.elevationAt(200));
        assertEquals(44.49245619568782, multiRoute2.elevationAt(650));
        assertEquals(13.994074009369504, multiRoute2.elevationAt(700));

        assertEquals(65.8248234904391, multiRoute3.elevationAt(100));
        assertEquals(89.7120302818561, multiRoute3.elevationAt(500));
        assertEquals(60.02202387408028, multiRoute3.elevationAt(650));
        assertEquals(89.62393478553496, multiRoute3.elevationAt(800));
        assertEquals(75.4177117448635, multiRoute3.elevationAt(1000));
        assertEquals(76.20068832149688, multiRoute3.elevationAt(1200));
        assertEquals(76.14939678896384, multiRoute3.elevationAt(1400));

        assertEquals(39.11099408612291, multiRoute4.elevationAt(100));
        assertEquals(76.44397634449163, multiRoute4.elevationAt(200));
        assertEquals(44.49245619568782, multiRoute4.elevationAt(650));
        assertEquals(13.994074009369504, multiRoute4.elevationAt(700));
        assertEquals(68.7166028911134, multiRoute4.elevationAt(1000));
        assertEquals(79.65981422787853, multiRoute4.elevationAt(1500));
        assertEquals(72.95412829561062, multiRoute4.elevationAt(1750));
        assertEquals(60.37202453747647, multiRoute4.elevationAt(2100));
    }
    ...
    void ElevationAtWorksOnEdgeValues() {
        ...
        //works on negative values
        assertEquals(50, multiRoute1.elevationAt(-1));
        assertEquals(50, multiRoute2.elevationAt(-1));
        assertEquals(30, multiRoute3.elevationAt(-1));
        assertEquals(50, multiRoute4.elevationAt(-1));

        //works on values greater than length
        assertEquals(70, multiRoute1.elevationAt(multiRoute1.length() + 1));
        assertEquals(30, multiRoute2.elevationAt(multiRoute2.length() + 1));
        assertEquals(70, multiRoute3.elevationAt(multiRoute3.length() + 1));
        assertEquals(70, multiRoute4.elevationAt(multiRoute4.length() + 1));

        //works on values equal to 0
        assertEquals(50, multiRoute1.elevationAt(0));
        assertEquals(50, multiRoute2.elevationAt(0));
        assertEquals(30, multiRoute3.elevationAt(0));
        assertEquals(50, multiRoute4.elevationAt(0));

        //works on values equal to length
        assertEquals(70, multiRoute1.elevationAt(multiRoute1.length()));
        assertEquals(30, multiRoute2.elevationAt(multiRoute2.length()));
        assertEquals(70, multiRoute3.elevationAt(multiRoute3.length()));
        assertEquals(70, multiRoute4.elevationAt(multiRoute4.length()));
    }
    ...
    void PointClosestToWorksOnValuesOutsideOfSegments() {
        ...
        assertEquals(new RoutePoint(new PointCh(2535797.894931484, 1152346.4929341371), 1685.4774585534042, 24.148620127378198), multiRoute4.pointClosestTo(new PointCh(2535816.4996,1152331.09741)));
