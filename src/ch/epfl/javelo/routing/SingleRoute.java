...
public final class SingleRoute implements Route {
    ...
    public double length() {
        double lenghtOfSegment = 0;
        for (Edge edge : edges) lenghtOfSegment += edge.length();
        return lenghtOfSegment;
    }
    ...
    public PointCh pointAt(double position) {
        ...
        int edgeIndex = edgeIndex(pos);

        double positionOnEdge = pos - positionsTab[edgeIndex];
        Edge rightEdge = edges.get(edgeIndex);
    ...
    public RoutePoint pointClosestTo(PointCh point) {
        ...
        double l = 0;
        double d = 0;
        PointCh pointOnEdge = edges.get(0).pointAt(0);
    ...
    private int edgeIndex(double pos) {
